    ...
    <div className={classes.registerBack} align="center">
      ...
      <Card
        ...
        sx={{
          ...
          maxHeight: 7000,
          background:
            "linear-gradient(45deg, #2F3031 20%, #575758 50%, #2F3031 30%,#575758 50%)",
          borderColor: "#fff",
          borderWidth: 1,
          borderRadius: 5,
          color: "action.home",
      ...
      >
        ...
        <CardContent>
          ...
          <div className={classes1.root5}>
            ...
            <FormHelperText sx={{ marginLeft: 7, color: "white" }}>
              Please select your role in system.
            </FormHelperText>
            ...
            <div className={classes.register}>
              <Typography
                variant="body1"
                sx={{ marginTop: 0.5, marginLeft: -13.5, color: "#bdbdbd" }}
              >
                Do You Have An Account?
                <Link to={"/Login"} className={classes1.root3}>
                  {" "}
                  Sign In{" "}
                </Link>
              </Typography>
