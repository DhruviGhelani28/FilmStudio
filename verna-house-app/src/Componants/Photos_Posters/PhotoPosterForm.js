    ...
    <Container align="center">
      ...
      >
        ...
        <CardContent>
          ...
          <Typography sx={{ color: "whitesmoke" }} variant="h6" fontSize="24px">
            Add Photos/Posters
          </Typography>
          <Grid container spacing={0}>
              ...
              <TextField
                ...
                onChange={(e) =>
                  setValues((prevStatus) => {
                    return { ...prevStatus, category: e.target.value };
                  })
                }
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onChange={(e) =>
                  setValues((prevStatus) => {
                    return { ...prevStatus, picture: e.target.files[0].name };
                  })
                }
              ></TextField>
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                onChange={(e) =>
                  setValues((prevStatus) => {
                    return { ...prevStatus, photoName: e.target.value };
                  })
                }
              />
            </Grid>
            <Grid item xs={12}>
              ...
              >
                ...
                <Select
                  ...
                  helpertext={
                    errors?.orderStatus ? errors.orderStatus.message : null
                  }
                  defaultValue=""
                  onChange={(event) => {
                    console.log(event.target.value);
                    setValues((prevStatus) => {
                      return { ...prevStatus, orderStatus: event.target.value };
                    });
                  }}
                >
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helpertext={
                  errors?.timeDuration ? errors.timeDuration.message : null
                }
                onChange={(e) =>
                  setValues((prevStatus) => {
                    return { ...prevStatus, timeDuration: e.target.value };
                  })
                }
              />
            </Grid>
